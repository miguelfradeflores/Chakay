...
int level_wallsX [][]= {{250, 900, 590, 200}, {250, 900, 550, 100, 550}, {250, 900, 550, 100, 550, 0, 1100}  };
...
void draw() {
  ...
  ellipse(posFinalX, posFinalY, 60, 60);

  // Check if character is near the final position
  //if (characterX>= posFinalX && characterX <=posFinalX &&
    //characterY >= posFinalY && characterY <=posFinalY     ) {
  if(dist(characterX, characterY, posFinalX, posFinalY) < 60 ){
